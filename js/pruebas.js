...
function probarValidarDescripcionRegalo() {
    ...
    console.assert(
        validarDescripcionRegalo('..,,') === "El campo descripción sólo puede contener letras y números",
        "Validar descripción no validó que sólo contenga letras y números",
    );
